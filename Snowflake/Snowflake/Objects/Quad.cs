...
namespace ComputerGraphics.Objects
{
    public class Quad
    {
        ...
        private void Initialize()
        {
            ...
            vertices[1] = new VertexPositionNormalTexture(new Vector3(this.SideLenght, 0f, 0), Vector3.Backward, new Vector2(1, 0));
            vertices[2] = new VertexPositionNormalTexture(new Vector3(0f, -1f * this.SideLenght, 0), Vector3.Backward, new Vector2(0, 1));
            vertices[3] = new VertexPositionNormalTexture(new Vector3(this.SideLenght, -1f * this.SideLenght, 0), Vector3.Backward, new Vector2(1, 1));
